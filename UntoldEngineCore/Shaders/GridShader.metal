...
vertex VertexOutput vertexGridShader(VertexInput vert [[stage_in]], constant Uniforms &uniformSpace [[buffer(gridUniform)]], uint vid [[vertex_id]]){
...
fragment FragmentOut fragmentGridShader(VertexOutput vertexOut [[stage_in]], constant Uniforms &uniformSpace [[buffer(gridUniform)]]){
