...
For complete Transform System documentation:
...
- **Rotate entities**: [02_RotateAnEntity.md](./02_RotateAnEntity.md)
- **Handle keyboard input**: [../02_Input/01_KeyboardMovement.md](../02_Input/01_KeyboardMovement.md)