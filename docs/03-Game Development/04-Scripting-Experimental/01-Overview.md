...
1. Read the **[USC Language Reference](./02-USC/01-USC.md)**
2. Try the **[USC Tutorials](./03-Tutorials/)**
...
**Use Swift for game development.**

See the main [Game Development Overview](../01-Overview.md) for the recommended workflow.
