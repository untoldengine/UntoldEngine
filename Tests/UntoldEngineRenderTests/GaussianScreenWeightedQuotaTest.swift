...
final class GaussianScreenWeightedQuotaTest: BaseRenderSetup {
    ...
    func testLayoutsArePinned() {
        ...
        XCTAssertEqual(gaussianBudgetStateTransitionOffset, 32)
        ...
        XCTAssertEqual(MemoryLayout<GaussianBudgetDensityTier>.offset(of: \.splats), 0)
        XCTAssertEqual(MemoryLayout<GaussianBudgetDensityTier>.offset(of: \.scaledArea), 4)
        ...
        XCTAssertEqual(MemoryLayout<GaussianBudgetDensityTier>.offset(of: \.levelledScaledArea), 20)
        ...
        XCTAssertEqual(gaussianDensityHistogramVisibleChunksOffset, 2060)
        ...
        // The per-chunk level additions (GaussianPagingTest.testLayoutsArePinned pins the indices).
        ...
        withUnsafeBytes(of: histogram) { bytes in
            XCTAssertEqual(bytes.load(fromByteOffset: 160, as: UInt32.self), 7, "tier t's splats sit at word 8t")
            XCTAssertEqual(bytes.load(fromByteOffset: 164, as: UInt32.self), 9, "and its scaled area at word 8t + 1")
            XCTAssertEqual(bytes.load(fromByteOffset: 176, as: UInt32.self), 0, "the level words follow, zero without levels")
        }
    }
