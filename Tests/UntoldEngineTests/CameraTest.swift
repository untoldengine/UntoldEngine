...
//        camera.translateCameraTo(10, 20, 30)
//        XCTAssertEqual(camera.localPosition, simd_float3(10, 20, 30))
//    }
//
//    func testTranslateBy() {
//        camera.translateCameraTo(0, 0, 0)
//        camera.translateCameraBy(delU: 1, delV: 2, delN: 3)
...
//        camera.translateCameraTo(0, 0, 10)
//        camera.updateCameraViewMatrix()
//        let expectedPosition = simd_float3(0, 0, -10)
//        let actualPosition = camera.getCameraPosition()
...
//
//        camera.cameraLookAt(eye: eye, target: target, up: up)
//
...
//        camera.translateCameraTo(0, 0, 10)
//        camera.orbitCameraAround(simd_float2(0.5, 0.5))
