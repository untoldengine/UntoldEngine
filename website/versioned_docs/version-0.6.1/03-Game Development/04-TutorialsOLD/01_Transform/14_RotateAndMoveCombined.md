...
4) **Build & test**
- In Xcode, run the GenerateScripts target to build the scripts, attach the script, press **Play**, hold **A/D** to spin and **W** to move forward. (USC scripts are authored in Xcode; the editor does not include a built-in script editor.)
