...
4) **Build & test**
- In Xcode, run the GenerateScripts target to build the scripts, attach the script, and use WASD to move along world axes. (USC scripts are authored in Xcode; the editor does not include a built-in script editor.)
