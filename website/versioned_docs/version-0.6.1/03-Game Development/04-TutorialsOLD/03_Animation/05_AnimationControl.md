...
1. Click **Scripts: Open in Xcode** (USC scripts are authored in Xcode; the editor does not include a built-in script editor)
...
In Xcode, open `AnimationController.swift` and add:
