...
U11DefenseAISystem::U11DefenseAISystem(){
    ...
    scheduler=new U4DEngine::U4DCallback<U11DefenseAISystem>;
...
void U11DefenseAISystem::setTeam(U11Team *uTeam){
...
void U11DefenseAISystem::computeDefendingSpace(){
...
void U11DefenseAISystem::assignDefendingSupportPlayers(){
...
void U11DefenseAISystem::interceptPass(){
...
void U11DefenseAISystem::startComputeDefendingSpaceTimer(){
    
    scheduler->scheduleClassWithMethodAndDelay(this, &U11DefenseAISystem::computeDefendingSpace, defendAnalysisTimer, 0.8, true);
    
}

void U11DefenseAISystem::removeComputeDefendingSpaceTimer(){
