...
//    U4DEngine::INPUTELEMENTTYPE macKeyWElement=U4DEngine::macKeyW;
...
//
//
//    myButtonA=new U4DEngine::U4DButton("buttonA",0.0,0.0,103,103,"ButtonA.png","ButtonAPressed.png");
//
...
//
//    //create a callback
//    U4DEngine::U4DCallback<KeyboardController>* buttonACallback=new U4DEngine::U4DCallback<KeyboardController>;
//
//    buttonACallback->scheduleClassWithMethod(this, &KeyboardController::actionOnMouseLeftButton);
//
...
//void KeyboardController::actionOnButtonA(){
//
