...
vertex VertexOutput vertexGridShader(VertexInput vert [[stage_in]], constant UniformSpace &uniformSpace [[buffer(uniformSpaceBufferIndex)]], uint vid [[vertex_id]]){
...
fragment FragmentOut fragmentGridShader(VertexOutput vertexOut [[stage_in]], constant UniformSpace &uniformSpace [[buffer(uniformSpaceBufferIndex)]]){
