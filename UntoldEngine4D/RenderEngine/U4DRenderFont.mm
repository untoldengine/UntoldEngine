...
namespace U4DEngine {
    ...
    U4DRenderFont::U4DRenderFont(U4DImage *uU4DImage):U4DEngine::U4DRenderImage(uU4DImage),fontOffset(0.0,0.0){
    ...
    bool U4DRenderFont::loadMTLBuffer(){
    ...
    void U4DRenderFont::loadMTLTexture(){
    ...
    void U4DRenderFont::setDiffuseTexture(const char* uTexture){
