...
public:
    ...
    std::string shaders[13]={"SkyBoxShader","imageShader","spriteShader","geometricShader","multiImageShader","NormalMapping","AnimationShader","modelShader","shadowShader","worldShader","simpleShader","lightShader","debugShader"};
