...
U4DPoint3n U4DOBB::getSupportPointInDirection(U4DVector3n& uDirection){
    ...
    float dotProduct=vertices.at(0).dot(uDirection);
    float support=0.0;
    
    //return the max dot product as the supporting vertex
    for(int i=1;i<vertices.size();i++){
        
        U4DVector3n vertex=vertices.at(i);
    ...
    U4DVector3n supportVector=vertices.at(index);
