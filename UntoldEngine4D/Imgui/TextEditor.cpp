...
{
	SetPalette(GetDraculaPalette());
	SetLanguageDefinition(LanguageDefinition::Gravity());
...
const TextEditor::Palette & TextEditor::GetDraculaPalette()
{
    const static Palette p = { {
            0xff7f7f7f,    // Default
            0xffa47262,    // Keyword
            0xfffde98b,    // Number
            0xff5555ff,    // String
            0xfff2f8f8, // Char literal
            0xff6cb8ff, // Punctuation
            0xff5555ff,    // Preprocessor
            0xfff2f8f8, // Identifier
            0xff5555ff, // Known identifier
            0xffc040a0, // Preproc identifier
            0xff8cfaf1, // Comment (single line)
            0xff8cfaf1, // Comment (multi line)
            0xff362a28, // Background
            0xffe0e0e0, // Cursor
            0x80a06020, // Selection
            0x800020ff, // ErrorMarker
            0x40f08000, // Breakpoint
            0xfff2f8f8, // Line number
            0x405a4744, // Current line fill
            0x40808080, // Current line fill (inactive)
            0x40a0a0a0, // Current line edge
        } };
    return p;
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CPlusPlus()
{
	...
	if (!inited)
	{
		static const char* const cppKeywords[] = {
			...
			"compl", "concept", "const", "constexpr", "const_cast", "continue", "decltype", "default", "delete", "do", "double", "dynamic_cast", "else", "enum", "explicit", "export", "extern", "false", "float","var","Player","U4DVector3n",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Gravity()
{
    static bool inited = false;
    static LanguageDefinition langDef;
    if (!inited)
    {
        static const char* const keywords[] = {
            "and", "break", "do", "", "else", "elseif", "end", "false", "for", "function", "if", "in", "", "local", "nil", "not", "or", "repeat", "return", "then", "true", "until", "while","var","func","class","U4DVector3n","U4DLogger","U4DModel","U4DCamera","U4DDynamicAction","U4DAnimation"
        };
