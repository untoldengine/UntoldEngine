...
extension PostFXPreset {
    public static let neutral = PostFXPreset(name: "Neutral")

    public static let cinematic = PostFXPreset(
        name: "Cinematic",
        colorGrading: true,
        exposure: -0.2,
        brightness: -0.05,
    ...
    public static let highContrast = PostFXPreset(
        name: "High Contrast",
        colorGrading: true,
        exposure: 0.15,
        brightness: 0.08,
    ...
    public static let softAO = PostFXPreset(
        name: "Soft AO",
        colorGrading: true,
        exposure: 0.0,
        brightness: 0.02,
    ...
    public static let archviz = PostFXPreset(
        name: "Archviz",
        colorGrading: true,
        exposure: 0.15,
        brightness: 0.05,
