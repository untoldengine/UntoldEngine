...
struct Material {
  ...
  var baseColorValue: simd_float4 = simd_float4(0.0, 0.0, 0.0, 1.0)
  var edgeTint: simd_float4 = simd_float4(0.0, 0.0, 0.0, 1.0)
  ...
  static private func makeTexture(
  ...
  static private func createColorTexture(from color: simd_float4) -> MTLTexture? {
