...
//        var cameraPosition: simd_float3 = getCameraPosition()
//
...
//        camera.translateCameraTo(cameraPosition.x, cameraPosition.y, cameraPosition.z)
//
...
//            camera.cameraLookAt(eye: cameraPosition, target: targetPosition + forward, up: up)
//        }
//    }
//
