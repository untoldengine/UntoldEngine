...
Beta version v0.0.14. See current [Release Notes](https://untoldengine.com/api/docs/html/md___users_haroldserrano__desktop__untold_engine_studio_api_docs_releasenotes.html) for improvement and fixes.
